...
# Backward-compatible symbol for tests and older integrations that still refer
# to the pre-v1.5 user workspace root directly. Runtime path resolution uses
# USERS_ROOT; callers that need the current layout should prefer that name.
MULTI_USER_ROOT = USERS_ROOT
