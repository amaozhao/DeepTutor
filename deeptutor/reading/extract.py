...
def _shared_extract(source: Path) -> str:
    ...
    """
    extractor = importlib.import_module("deeptutor.utils.document_extractor")
    validator = importlib.import_module("deeptutor.utils.document_validator")

    try:
        return extractor.extract_text_from_path(
            source, max_bytes=validator.DocumentValidator.MAX_FILE_SIZE, max_chars=None
        )
