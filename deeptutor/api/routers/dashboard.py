...
def _get_suggestions_module():
    return importlib.import_module("deeptutor.services.suggestions")
...
async def get_starter_suggestions():
    ...
    """
    return await _get_suggestions_module().get_suggestions()
...
async def refresh_starter_suggestions():
    ...
    different set.
    """
    result = await _get_suggestions_module().refresh_suggestions()
