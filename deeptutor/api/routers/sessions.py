...
router = APIRouter()
_DEFAULT_SQLITE_SESSION_GETTER = get_sqlite_session_store


def _get_route_session_store():
    if get_sqlite_session_store is not _DEFAULT_SQLITE_SESSION_GETTER:
...
async def list_sessions(
    ...
    store = _get_route_session_store()
