...
def _is_partner_turn() -> bool:
    try:
        ...
        scope = importlib.import_module("deeptutor.services.partners.scope")
        return bool(scope.is_partner_user_id(context.get_current_user().id))
...
def _is_admin() -> bool:
    ...
    try:
        ...
        return True
    try:
        return bool(context.get_current_user().is_admin)
