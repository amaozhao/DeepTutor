...
const ResolvedAskUserCard = memo(function ResolvedAskUserCard({
  ...
  const { t } = useTranslation();
  // Once the user manually toggles, their choice wins. Until then, derive
  // collapsed state from the latest default so progress re-renders stay cheap.
  const [collapsedOverride, setCollapsedOverride] = useState<boolean | null>(null);
  const collapsed = collapsedOverride ?? (defaultCollapsed && collapsible);
