...
def _optional_loader_modules():
    pytest.importorskip("llama_index.core")
    parsing = __import__("deeptutor.services.parsing", fromlist=["parsing"])
    parsed_document = __import__(
    ...
    return parsing, parsed_document, loader
...
def test_loader_routes_parser_files_through_active_parse_engine(
    ...
    _parsing, ParsedDocument, LlamaIndexDocumentLoader = _optional_loader_modules()
...
def test_loader_keeps_event_loop_responsive_while_parser_blocks(
    ...
    parsing, ParsedDocument, LlamaIndexDocumentLoader = _optional_loader_modules()
